var config = {
    ...
    markerImage: './images/icon.png',
    markerImageSize: [32,32],
    ...
    footer: '<a href="https://github.com/DieguitoSP/Desafio2/blob/main/README.md" />Créditos y Autoría<br> Created using <a href="https://github.com/digidem/maplibre-storymap" target="_blank">MapLibre Storytelling</a> template.',
    chapters: [
        {
            id: 'IntroHaring',
            alignment: 'left',
